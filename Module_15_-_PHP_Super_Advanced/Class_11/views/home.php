							...
							<?php foreach($adverts as $advert) : ?>
								<tr>
									<td>
										...
										<img src="<?php echo BASE_URL; ?>assets/img/adverts/<?php echo $advert['url']; ?>" border="0" height='50'>
										<?php else : ?>
											<img src="<?php echo BASE_URL; ?>assets/img/default.png" height='50' border="0">
										<?php endif; ?>
									</td>
									<td>
										<a href="<?php echo BASE_URL; ?>product/open/<?php echo $advert['id']; ?>"><?php echo $advert['title']; ?></a><br>
